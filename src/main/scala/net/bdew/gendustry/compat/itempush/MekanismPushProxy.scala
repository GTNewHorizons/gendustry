...
object MekanismPushProxy extends ItemPushProxy {
  ...
  val iTransporterTileCls =
    try {
      Class
        .forName("mekanism.common.base.ITransporterTile")
        .asInstanceOf[Class[ITransporterTile]]
    } catch {
      case t: Throwable =>
        Gendustry.logWarnException(
          "Failed to load mekanism logistical transporter class",
          t
        )
        null
    }
  ...
  val iLogisticalTransporterCls =
    try {
      Class
        .forName("mekanism.common.base.ILogisticalTransporter")
        .asInstanceOf[Class[ILogisticalTransporter]]
    } catch {
      case t: Throwable =>
        Gendustry.logWarnException(
          "Failed to load mekanism logistical transporter class",
