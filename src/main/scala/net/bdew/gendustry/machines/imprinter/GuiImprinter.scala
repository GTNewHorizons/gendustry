...
class GuiImprinter(val te: TileImprinter, player: EntityPlayer)
    extends BaseScreen(new ContainerImprinter(te, player), 176, 166) {
  ...
  override def initGui() {
    ...
    inventorySlots
      ...
      .setBackgroundIcon(HintIcons.template)
  }
}
